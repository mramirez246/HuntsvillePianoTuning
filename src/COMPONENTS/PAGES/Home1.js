                ...
                <ResponsiveWrapper>
                    <PhoneScreen>
                        ...
                        <Grid orientation="row" template="1fr" gap="1em" classes="">
                            ...
                            <Text text={`In 2021, Miguel embarked on a new chapter in Huntsville, AL, relocating with his wife and two daughters. He finds so much joy in assisting the local community and those in surrounding areas with their pianos and guiding them on their musical paths. Miguel's dedication to you and your musical journey ensures your playing will resonate at its finest. Book a tuning with Miguel today!`} fontSize="1.5em" weight="400" color="" spacing="" lineHeight="" classes=""/>
                    ...
                    <TabletScreen>
                        <Box width="" height="" radius="" backgroundColor="" paddingV="0" paddingH="3vw" classes="">
                            ...
                            <Text text={`In 2021, Miguel embarked on a new chapter in Huntsville, AL, relocating with his wife and two daughters. He finds so much joy in assisting the local community and those in surrounding areas with their pianos and guiding them on their musical paths. Miguel's dedication to you and your musical journey ensures your playing will resonate at its finest. Book a tuning with Miguel today!`} fontSize="1.2em" weight="400" color="" spacing="" lineHeight="" classes=""/>
                            </Grid>
                        </Box>
                            ...
                            <Heading4 text={`About`} />
                                <Box width="" height="" radius="" backgroundColor="" paddingV="2em" paddingH="0" classes="">
                                    <Grid orientation="column" template="2fr 1fr" gap="1em" classes="center">
                                            ...
                                            <Text text={`In 2021, Miguel embarked on a new chapter in Huntsville, AL, relocating with his wife and two daughters. He finds so much joy in assisting the local community and those in surrounding areas with their pianos and guiding them on their musical paths. Miguel's dedication to you and your musical journey ensures your playing will resonate at its finest. Book a tuning with Miguel today!`} fontSize="2vw" weight="400" color="" spacing="" lineHeight="" classes=""/>
                                            </Grid>
                    ...
                    <DesktopScreen>
                        <Box width="" height="" radius="" paddingV="2em" paddingH="13vw" classes="">
                            ...
                            <Box width="" height="" radius="" backgroundColor="" paddingV="0" paddingH="" classes="">
                                ...
                                <Text text={`In 2021, Miguel embarked on a new chapter in Huntsville, AL, relocating with his wife and two daughters. He finds so much joy in assisting the local community and those in surrounding areas with their pianos and guiding them on their musical paths. Miguel's dedication to you and your musical journey ensures your playing will resonate at its finest. Book a tuning with Miguel today!`} fontSize="1.5vw" weight="400" color="" spacing="" lineHeight="" classes=""/>
                                </Grid>
