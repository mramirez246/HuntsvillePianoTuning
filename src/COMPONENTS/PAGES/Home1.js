                ...
                <ResponsiveWrapper>
                    <PhoneScreen>
                        ...
                        <Grid orientation="row" template="1fr" gap="1em" classes="">
                            ...
                            <Text text={`Miguel's deep-rooted connection to music traces back to his childhood within a musically inclined family. He began his musical journey at the tender age of 3, on both the piano and violin. As he progressed in his musical career, Miguel achieved the status of a concert violinist and teacher. Along this path, he had the privilege of receiving instruction from renowned violinists such as David Chan, the concertmaster of The Metropolitan Opera Orchestra in New York, and Juan Ramirez, an Atlanta Symphony Orchestra violinist who also happens to be Miguel's uncle.`} fontSize="1.5em" weight="400" color="" spacing="" lineHeight="" classes=""/>
                            ...
                            <Text text={`In 2021, Miguel embarked on a new chapter in Huntsville, AL, relocating with his wife and two daughters. He finds immense joy in assisting the local community and those in surrounding areas with their pianos and helping inspire their musical journeys. Book a tuning with Miguel today!`} fontSize="1.5em" weight="400" color="" spacing="" lineHeight="" classes=""/>
                    ...
                    <TabletScreen>
                        <Box width="" height="" radius="" backgroundColor="" paddingV="0" paddingH="3vw" classes="">
                            ...
                            <Text text={`In 2021, Miguel embarked on a new chapter in Huntsville, AL, relocating with his wife and two daughters. He finds immense joy in assisting the local community and those in surrounding areas with their pianos and helping inspire their musical journeys. Book a tuning with Miguel today!`} fontSize="1.2em" weight="400" color="" spacing="" lineHeight="" classes=""/>
                            </Grid>
                        </Box>
                            ...
                            <Heading4 text={`About`} />
                                <Box width="" height="" radius="" backgroundColor="" paddingV="2em" paddingH="0" classes="">
                                    <Grid orientation="column" template="2fr 1fr" gap="1em" classes="center">
                                            ...
                                            <Text text={`In 2021, Miguel embarked on a new chapter in Huntsville, AL, relocating with his wife and two daughters. He finds immense joy in assisting the local community and those in surrounding areas with their pianos and helping inspire their musical journeys. Book a tuning with Miguel today!`} fontSize="2vw" weight="400" color="" spacing="" lineHeight="" classes=""/>
                                            </Grid>
                    ...
                    <DesktopScreen>
                        <Box width="" height="" radius="" paddingV="2em" paddingH="13vw" classes="">
                            ...
                            <Box width="" height="" radius="" backgroundColor="" paddingV="0" paddingH="" classes="">
                                ...
                                <Text text={`In 2021, Miguel embarked on a new chapter in Huntsville, AL, relocating with his wife and two daughters. He finds immense joy in assisting the local community and those in surrounding areas with their pianos and helping inspire their musical journeys. Book a tuning with Miguel today!`} fontSize="1.5vw" weight="400" color="" spacing="" lineHeight="" classes=""/>
                                </Grid>
